			...
			public void execute() {
				...
				for(PartsItemWarrantyView partsView : parts){
					if(StringUtils.isNotEmpty(partsView.getPartsItemName())){
						...
						List<InventoryItemTypeM> itemTypes = inventoryItemTypeRepository.findActiveByName(partsView.getPartsItemName().trim());
						if(itemTypes != null && !itemTypes.isEmpty()){
							insurancePartsItemM.setItemType(itemTypes.get(0));
						}
